...
- `shared/outputs/` -> usar apenas quando o SIVI pedir uma saída que precise circular entre agentes
- `shared/lessons/` -> usar apenas para aprendizados realmente transversais
